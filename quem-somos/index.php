...
<html lang="pt-br">
	<head>
		...
		<meta name="description" content="Informações sobre a estrutura do lar São Vicente de Paula da cidade de Sorocaba" />
      ...
      <div class="jumbotron mb-0">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img class="featurette-image img-fluid mx-auto" src="../img/quem-somos/cabelereiro.jpg" alt="Homem cortando o cabelo de uma mulher">
              <div class="container">
                <div class="carousel-caption">
                  <h2 class="featurette-heading"><span class="text-muted">Cabelereiro</span></h2>
                  <p class="lead">Alugue nosso salão com palco. Ampla área externa coberta para Eventos beneficentes ou particulares</p>
                </div>
              </div>
            </div>
